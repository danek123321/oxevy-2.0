...
class ClickGuiModule : Module("ClickGui", "Opens the ClickGui", Module.Category.CLIENT) {
    ...
    @JvmField val color: Setting<Color> = color("Color", Color(0, 100, 255, 255))
    @JvmField val colorPreset: Setting<ColorPreset> = mode("ColorPreset", ColorPreset.BLUE)
    @JvmField val topColor: Setting<Color> = color("TopColor", Color(0, 80, 150, 255))
